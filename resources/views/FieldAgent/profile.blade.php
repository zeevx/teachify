@extends('layouts.fieldagent-main')
@section('title')
    Teachify - Profile
@endsection
@section('content')
                                ...
                                <form action="{{ route('submit.faprofile') }}" method="post">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="state" name="state" type="text" value="@if(!empty($fieldagent->state)){{ $fieldagent->state }}@endif" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-control-label" for="lga">LGA</label>
                                            <input class="form-control" name="lga" value="@if(!empty($fieldagent->lga)){{ $fieldagent->lga }}@endif">
                                        </div>
                                    </div>
                                    <button class="btn btn-success">Update</button>
                                </div>
