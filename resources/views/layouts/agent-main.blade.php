                    ...
                    <li class="nav-item" id="dropdown">
                        ...
                        <div id="dropdown-lvl2" class="panel-collapse collapse">
                            <div class="panel-body">
                                <ul>
                                    <li>
                                        <a class="nav-link" href="{{ route('agent.users.create', 'id=3') }}">Add Field Agents</a>
                                    </li>
                                    <li>
                                        <a class="nav-link" href="{{ route('agent.users.create', 'id=5') }}">Add Schools</a>
                                    </li>
                                    <li>
                                        <a class="nav-link" href="{{ route('agent.users.create', 'id=6') }}">Add Teachers</a>
                                    </li>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('agent.fieldagents.index') }}">
                            <i class="ni ni-delivery-fast text-yellow"></i>
                            <span class="nav-link-text">My Field Agents</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('agent.schools.index') }}">
                            <i class="ni ni-hat-3 text-info"></i>
                            <span class="nav-link-text">Schools</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('agent.teachers.index') }}">
                ...
                <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu  dropdown-menu-right ">
                            ...
                            <a href="{{ url('aprofile', Auth::user()->id) }}" class="dropdown-item">
