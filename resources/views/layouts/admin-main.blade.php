        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item" id="dropdown">
                        ...
                        <div id="dropdown-lvl2" class="panel-collapse collapse">
                            <div class="panel-body">
                                <ul>
                                    <li>
                                        <a class="nav-link" href="{{ route('admin.users.create', 'id=2') }}">Add Admins</a>
                                    </li>
                                    <li>
                                        <a class="nav-link" href="{{ route('admin.users.create', 'id=3') }}">Add Field Agents</a>
                                    </li>
                                    <li>
                                        <a class="nav-link" href="{{ route('admin.users.create', 'id=4') }}">Add Agents</a>
                                    </li>
                                    <li>
                                        <a class="nav-link" href="{{ route('admin.users.create', 'id=5') }}">Add Schools</a>
                                    </li>
                                    <li>
                                        <a class="nav-link" href="{{ route('admin.users.create', 'id=6') }}">Add Teachers</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.fieldagents.index') }}">
