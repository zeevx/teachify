        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('fieldagent.schools.index') }}">
                            <i class="ni ni-hat-3 text-info"></i>
                            <span class="nav-link-text">Schools</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('fieldagent.teachers.index') }}">
                ...
                <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu  dropdown-menu-right ">
                            ...
                            <a href="{{ url('faprofile', Auth::user()->id) }}" class="dropdown-item">
