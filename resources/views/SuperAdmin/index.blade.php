                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Super Admins</h5>
                                        <span class="h2 font-weight-bold mb-0">{{ count($superAdmins) > 0 ? count($superAdmins) : "O" }}</span>
                                    </div>
                                    <div class="col-auto">
                ...
                <div class="card bg-default">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-light text-uppercase ls-1 mb-1">Website (Updated 2 Mins ago)</h6>
                                <h5 class="h3 text-white mb-0">Monitor</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <p style="color: green; font-weight: bold">
                            <b style="color: white">Server: </b> Online <i class="ni ni-check-bold"></i>
                        </p>
                        <p style="color: green; font-weight: bold">
                            <b style="color: white">Database: </b> Online <i class="ni ni-check-bold"></i>
                        </p>
                        <p style="color: green; font-weight: bold">
                            <b style="color: white">SSH: </b> Online <i class="ni ni-check-bold"></i>
                        </p>
                        <p style="color: green; font-weight: bold">
                            <b style="color: white">URL: </b> {{ url('') }}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <table id="example" class="table align-items-center" style="width:100%">
                    ...
                    @forelse($users as $user)
                        <tr>
                            ...
                            <td>
                                <button class="btn-sm btn-outline-primary" onclick="window.location = '{{ url('profile', $user->id) }}';"> Edit/View </button>
